...
// If statement ATMega8515: https://stackoverflow.com/questions/63996297/does-anybody-knows-how-to-do-an-if-statement-in-assembly-for-atmega328p
...
// Configuramos el stack pointer 
			LDI		R16,0X04
			OUT		SPH,R16		// Parte alta del registro del stack pointer
			LDI		R16,0XFF
			OUT		SPL,R16		// Parte baja del registro del stack pointer
